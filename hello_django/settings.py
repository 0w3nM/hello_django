...
ALLOWED_HOSTS = ['8000-0w3nm-hello-django-u4nbk57t34.us2.codeanyapp.com']
...
DATABASES = {
    'default': dj_database_url.parse('postgres://agmshllu:FCnc6XKCXa-Y1B80QOGpINF3W4O-1_Zi@flora.db.elephantsql.com/agmshllu')
}
